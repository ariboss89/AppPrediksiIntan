...
//            java.sql.ResultSet res = stmt.executeQuery("select distinct(idbarang) from dt_masuk where status = 'Proses'");
//            if(res.next()) {
//                cbNamaBarang.addItem(res.getString("idbarang"));
//            }
...
//    }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        } else if (Integer.parseInt(txtStok.getText()) == 0) {
            JOptionPane.showMessageDialog(null, "Field Tidak Boleh Kosong !!");
    ...
    private void cbNamaBarangItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbNamaBarangItemStateChanged
        ...
        try {
            java.sql.Statement stmt = conn.createStatement();
            java.sql.ResultSet res = stmt.executeQuery("select *from tb_barang WHERE nama = '"+cbNamaBarang.getSelectedItem().toString()+"'");
            while (res.next()) {
