...
public class DetailMasuk {
    ...
    public void SaveDetail(String iddetailmasuk, String idmasuk, String idbarang, int jumlah, Date tanggal) {
        con = new Koneksi();
        con.connect();
        try {
            st = con.conn.createStatement();
            query = "insert into dt_masuk(iddetailmasuk, idmasuk, idbarang, tanggal, jumlah, status)values('" + iddetailmasuk + "','" + idmasuk + "','" + idbarang + "','"+tanggal+"','" + jumlah + "', 'Proses')";
